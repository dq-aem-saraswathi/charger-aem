...
<c:set var="clientLib"
       value="<%= xssAPI.encodeForHTMLAttr("acs-tools.csv-asset-importer.app") %>"
       scope="request"/>

<c:set var="app"
       value="<%= xssAPI.encodeForHTMLAttr("adobe-" + component.getName() + "-app") %>"
       scope="request"/>
...
<html>
    ...
    <body class="coral--light acs-tools-page">
        ...
        <div id="adobe-${component.name}-app">
